...
The main window also supports ⌘1 through ⌘9 to jump to any sidebar section, ⌘[ to go back, ⌘E to toggle bulk-select, ⇧⌘R to rescan your library, and ⇧⌘F to open the Rename Files tool.
...
| ⇧⌘R | Scan library |
| ⇧⌘F | Rename Files tool |
| ⌘1 through ⌘9 | Jump to sidebar section |
| ⌘[ | Go back |
